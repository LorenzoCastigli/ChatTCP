...
public class Chatter {
    ...
    public void gestore(){
        ...
        System.out.println("Che azione vuoi eseguire ?\n1)Cambia il tuo stato\n2)Cambia il tuo nome\n3)Scrivi un messaggio\n4)Chiudi");
        BufferedReader tastiera = new BufferedReader(new InputStreamReader(System.in));
        
        try {
                
                String var = tastiera.readLine();            
                int scelta = Integer.parseInt(var);
                
            switch(scelta){
            
                case 1: 

                    System.out.println("Che stato vuoi avere ?\n1)Online\n2)Offline");

                    try {

                        var = tastiera.readLine();            
                        scelta = Integer.parseInt(var);
